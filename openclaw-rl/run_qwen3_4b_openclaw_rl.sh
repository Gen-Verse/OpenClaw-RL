...
export REWARD_MODEL_ENABLE="${REWARD_MODEL_ENABLE:-0}"
export REWARD_MODEL_SCORE_ENABLE="${REWARD_MODEL_SCORE_ENABLE:-0}"
export REWARD_MODEL_MIN_RECORDS="${REWARD_MODEL_MIN_RECORDS:-50}"
export REWARD_MODEL_MIN_NEGATIVES="${REWARD_MODEL_MIN_NEGATIVES:-5}"
export REWARD_MODEL_TRAIN_INTERVAL="${REWARD_MODEL_TRAIN_INTERVAL:-300}"
export REWARD_MODEL_LR="${REWARD_MODEL_LR:-1e-5}"
